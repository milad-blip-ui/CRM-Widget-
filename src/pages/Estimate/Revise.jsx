...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
      ...
      .filter(item => item !== null);
       ...
       const completeData = {
         data: {
           ...
           Quote_Rev_int: estimateData.Quote_Rev_int === null ? 1 : estimateData.Quote_Rev_int + 1
         }
       };
    ...
    try {
      const result = await reviseEstimate(id,payload, customerAttachments, privateAttachments,payload2);
      if (result.data) {
